...
#define DEV_OTHER_SNGL 4        // other single device
...
#define GP_DEV_OTHER DEV_OTHER_SNGL
...
typedef struct {
    ...
    GW_HOME_SECURITY_ALARM_DEV_CB gw_home_security_alarm_env_dev_cb;//环境设备，跟撤离布防无关
