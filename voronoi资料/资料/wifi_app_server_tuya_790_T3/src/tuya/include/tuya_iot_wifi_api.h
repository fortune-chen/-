...
/***********************************************************
*  Function: tuya_iot_wf_nw_reconnect_interval_set
*  Desc:     set wifi nw reconnect interval
*  Input:    time in sec
*  Note: must call first
***********************************************************/
VOID tuya_iot_wf_nw_reconnect_interval_set(IN CONST UINT_T reconnect_interval);
